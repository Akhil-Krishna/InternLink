...
(1, 11, 'Rejected', 'Strong technical background but we were looking for candidates with more environmental science coursework and R programming experience.', 'I am passionate about using data analysis to address environmental challenges. My computer science background combined with statistical analysis skills from my coursework would be valuable for analyzing environmental impact data and creating sustainability reports.', 'resumes/sarah_chen_resume.pdf', '2025-07-22 10:30:00'),
(1, 12, 'Pending', NULL, 'The intersection of software development and environmental sustainability deeply interests me. My experience with Python and C++ from university projects, combined with my passion for green technology, makes me excited about developing software solutions for renewable energy systems.', 'resumes/sarah_chen_resume.pdf', '2025-07-23 14:15:00'),
